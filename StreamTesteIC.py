...
def ajuste_weibull():
    ...
    parameters_1 = scipy.stats.exponweib.fit(data,floc=0,f0=1)
    fitness_1 = scipy.stats.kstest(data,"exponweib",parameters_1)
...
def ajuste_exponencial():
    ...
    parameters_2 = scipy.stats.expon.fit(data,floc=0)
    fitness_2 = scipy.stats.kstest(data,"expon",parameters_2)
